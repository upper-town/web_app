...
ActiveRecord::Schema[8.1].define(version: 2025_11_01_150630) do
  ...
  create_table "demo_webhook_events", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.jsonb "data", default: {}, null: false
    ...
    t.index ["type"], name: "index_demo_webhook_events_on_type"
    t.index ["uuid"], name: "index_demo_webhook_events_on_uuid", unique: true
  end
