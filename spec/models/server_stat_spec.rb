...
RSpec.describe ServerStat do
  ...
  describe 'validations' do
    it 'validates period' do
      ...
      server_stat = build(:server_stat, period: described_class::PERIODS.sample)
      server_stat.validate
  ...
  describe '.reference_date_for' do
    ...
    context 'when period is something else' do
      it 'raises an error' do
        ...
        end.to raise_error(/Invalid period for ServerStat.reference_date_for/)
      end
    end
  end
  ...
  describe '.reference_range_for' do
    ...
    context 'when period is something else' do
      it 'raises an error' do
        ...
        end.to raise_error(/Invalid period for ServerStat.reference_range_for/)
      end
    end
  end
  ...
  describe '.next_time_for' do
    ...
    context 'when period is something else' do
      it 'raises an error' do
        ...
        end.to raise_error(/Invalid period for ServerStat.next_time_for/)
      end
    end
  end
    ...
    context 'when past_time is greater than current_time' do
      it 'raises an error' do
        freeze_time do
          ...
          end.to raise_error(/Invalid past_time or current_time for ServerStat.loop_through/)
        end
      end
    end
