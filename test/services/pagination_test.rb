...
class PaginationTest < ActiveSupport::TestCase
  ...
  describe "#first_page_url, #prev_page_url, #page_url, #next_page_url, #last_page_url" do
    it "returns accordingly" do
      ...
      pagination = described_class.new(relation, request, per_page: 4, page: 1)
      assert_equal("http://test.upper.town/servers?page=1", pagination.first_page_url)
      assert_equal("http://test.upper.town/servers?page=1", pagination.prev_page_url)
      assert_equal("http://test.upper.town/servers?page=1", pagination.page_url(1))
      assert_equal("http://test.upper.town/servers?page=2", pagination.next_page_url)
      assert_equal("http://test.upper.town/servers?page=3", pagination.last_page_url)

      pagination = described_class.new(relation, request, per_page: 4, page: 1, per_page_from_request: true)
      assert_equal("http://test.upper.town/servers?page=1&per_page=4", pagination.first_page_url)
      assert_equal("http://test.upper.town/servers?page=1&per_page=4", pagination.prev_page_url)
      assert_equal("http://test.upper.town/servers?page=1&per_page=4", pagination.page_url(1))
      assert_equal("http://test.upper.town/servers?page=2&per_page=4", pagination.next_page_url)
      assert_equal("http://test.upper.town/servers?page=3&per_page=4", pagination.last_page_url)

      pagination = described_class.new(relation, request, per_page: 4, page: 2)
      assert_equal("http://test.upper.town/servers?page=1", pagination.first_page_url)
      assert_equal("http://test.upper.town/servers?page=1", pagination.prev_page_url)
      assert_equal("http://test.upper.town/servers?page=2", pagination.page_url(2))
      assert_equal("http://test.upper.town/servers?page=3", pagination.next_page_url)
      assert_equal("http://test.upper.town/servers?page=3", pagination.last_page_url)

      pagination = described_class.new(relation, request, per_page: 4, page: 2, per_page_from_request: true)
      assert_equal("http://test.upper.town/servers?page=1&per_page=4", pagination.first_page_url)
      assert_equal("http://test.upper.town/servers?page=1&per_page=4", pagination.prev_page_url)
      assert_equal("http://test.upper.town/servers?page=2&per_page=4", pagination.page_url(2))
      assert_equal("http://test.upper.town/servers?page=3&per_page=4", pagination.next_page_url)
      assert_equal("http://test.upper.town/servers?page=3&per_page=4", pagination.last_page_url)

      pagination = described_class.new(relation, request, per_page: 4, page: 3)
      assert_equal("http://test.upper.town/servers?page=1", pagination.first_page_url)
      assert_equal("http://test.upper.town/servers?page=2", pagination.prev_page_url)
      assert_equal("http://test.upper.town/servers?page=3", pagination.page_url(3))
      assert_equal("http://test.upper.town/servers?page=3", pagination.next_page_url)
      assert_equal("http://test.upper.town/servers?page=3", pagination.last_page_url)

      pagination = described_class.new(relation, request, per_page: 4, page: 3, per_page_from_request: true)
      assert_equal("http://test.upper.town/servers?page=1&per_page=4", pagination.first_page_url)
      assert_equal("http://test.upper.town/servers?page=2&per_page=4", pagination.prev_page_url)
      assert_equal("http://test.upper.town/servers?page=3&per_page=4", pagination.page_url(3))
      assert_equal("http://test.upper.town/servers?page=3&per_page=4", pagination.next_page_url)
      assert_equal("http://test.upper.town/servers?page=3&per_page=4", pagination.last_page_url)
    end
  end
