...
module Auth
  module AdminUserAuthenticationControl
    ...
    include AdminUserManageSession
    include ManageReturnTo

    included do
      before_action(
        :current_admin_user_session,
        :current_admin_user,
        :current_admin_user_account
      )
      helper_method(
        :current_admin_user_session,
        :current_admin_user,
    ...
    def authenticate_admin_user!
      if !current_admin_user_session
        raise NotAuthenticatedError
      end

      if current_admin_user_session.expired?
