...
#                        admin_users_sign_up GET    /admin_users/sign_up(.:format)                        admin_users/email_confirmations#new
#                        admin_users_sign_in GET    /admin_users/sign_in(.:format)                        admin_users/sessions#new
#                       admin_users_sign_out GET    /admin_users/sign_out(.:format)                       admin_users/sessions#destroy
#        edit_admin_users_email_confirmation GET    /admin_users/email_confirmation/edit(.:format)        admin_users/email_confirmations#edit
#             admin_users_email_confirmation PATCH  /admin_users/email_confirmation(.:format)             admin_users/email_confirmations#update
#                                            PUT    /admin_users/email_confirmation(.:format)             admin_users/email_confirmations#update
#                                            POST   /admin_users/email_confirmation(.:format)             admin_users/email_confirmations#create
# edit_admin_users_change_email_confirmation GET    /admin_users/change_email_confirmation/edit(.:format) admin_users/change_email_confirmations#edit
#      admin_users_change_email_confirmation PATCH  /admin_users/change_email_confirmation(.:format)      admin_users/change_email_confirmations#update
#                                            PUT    /admin_users/change_email_confirmation(.:format)      admin_users/change_email_confirmations#update
#    edit_admin_users_change_email_reversion GET    /admin_users/change_email_reversion/edit(.:format)    admin_users/change_email_reversions#edit
#         admin_users_change_email_reversion PATCH  /admin_users/change_email_reversion(.:format)         admin_users/change_email_reversions#update
#                                            PUT    /admin_users/change_email_reversion(.:format)         admin_users/change_email_reversions#update
#             new_admin_users_password_reset GET    /admin_users/password_reset/new(.:format)             admin_users/password_resets#new
#            edit_admin_users_password_reset GET    /admin_users/password_reset/edit(.:format)            admin_users/password_resets#edit
#                 admin_users_password_reset PATCH  /admin_users/password_reset(.:format)                 admin_users/password_resets#update
#                                            PUT    /admin_users/password_reset(.:format)                 admin_users/password_resets#update
#                                            POST   /admin_users/password_reset(.:format)                 admin_users/password_resets#create
#            destroy_all_admin_users_session DELETE /admin_users/sessions/:id/destroy_all(.:format)       admin_users/sessions#destroy_all
